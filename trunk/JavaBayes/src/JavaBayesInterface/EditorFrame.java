...
public class EditorFrame extends Frame {
	 ...
	 */
	public EditorFrame(final JavaBayes java_bayes, final String title) {
		super(title);
	...
	public boolean action(final Event evt, final Object arg) {
		if (evt.target instanceof Button) {
			final String label = ((Button) (evt.target)).getLabel();
	 ...
	 */
	public boolean open_url(final String filename) {
		InferenceGraph ig;
	...
	public boolean save(final String filename) {
		final InferenceGraph ig = get_inference_graph();
		...
		try {
			...
			final PrintStream out = new PrintStream(fileout);
			switch (save_format) {
			case BIF_FORMAT:
				ig.save_bif(out);
				break;
	 ...
	 * Process a query.
	 */
	public void process_query(final InferenceGraph ig,
			final String queried_variable) {
		...
		final PrintStream pstream = new PrintStream(bstream);
	 ...
	 */
	protected void print_bayes_net(final PrintStream pstream,
			final InferenceGraph ig) {
	 ...
	 * InferenceGraph.
	 */
	protected void print_marginal(final PrintStream pstream,
			final InferenceGraph ig, final String queried_variable) {
	 ...
	 */
	protected void print_expectation(final PrintStream pstream,
			final InferenceGraph ig, final String queried_variable) {
		if (algorithm_type == ALGORITHM_VARIABLE_ELIMINATION)
	 ...
	 */
	protected void print_explanation(final PrintStream pstream,
			final InferenceGraph ig) {
	 ...
	 */
	protected void print_full_explanation(final PrintStream pstream,
			final InferenceGraph ig) {
	 ...
	 * InferenceGraph.
	 */
	protected void print_sensitivity_analysis(final PrintStream pstream,
			final InferenceGraph ig) {
	 ...
	 */
	public void set_inference_graph(final InferenceGraph ig) {
	 ...
	 */
	public void set_current_save_filename(final String csf) {
	 ...
	 */
	public void what_to_show_bucket_tree_action(
			final boolean what_to_show_bucket_tree) {
	...
	public void what_to_show_bayesian_network_action(
			final boolean what_to_show_bayesian_network) {
	 ...
	 */
	public void set_save_format(final int sf) {
		save_format = sf;
	}
	 ...
	 */
	public void set_algorithm(final int type) {
		algorithm_type = type;
	}
}

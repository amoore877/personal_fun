...
public class XMLBIFv03 extends InterchangeFormat implements XMLBIFv03Constants {
	...
	final public IFProbabilityVariable VariableContent(final String name)
			throws ParseException {
		int i;
		String s, v, svalues[];
		final Vector properties = new Vector();
		...
		Enumeration e;
		final IFProbabilityVariable pv = new IFProbabilityVariable();
		label_3: while (true) {
			switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
			case SOT:
				;
	...
	final public IFProbabilityFunction ProbabilityDeclaration()
			throws ParseException {
		final String vs[];
		final IFProbabilityFunction upf = new IFProbabilityFunction();
	...
	final public void ProbabilityContent(final IFProbabilityFunction upf)
			throws ParseException {
		int i, j;
		final double def[] = null;
		double tab[] = null;
		String s, vs[];
		final IFProbabilityEntry entry = null;
		Enumeration e;

		final Vector fors = new Vector();
		final Vector givens = new Vector();
		final Vector properties = new Vector();
		final Vector entries = new Vector();
		final Vector defaults = new Vector();
	...
	final public double[] FloatingPointList() throws ParseException {
		...
		Double d;
		double ds[];
		final Vector d_list = new Vector();
		Enumeration e;
	...
	public XMLBIFv03(final java.io.InputStream stream) {
	...
	public XMLBIFv03(final XMLBIFv03TokenManager tm) {
		token_source = tm;
		token = new Token();
		jj_ntk = -1;
		jj_gen = 0;
	...
	public void ReInit(final XMLBIFv03TokenManager tm) {
		token_source = tm;
		token = new Token();
		jj_ntk = -1;
		jj_gen = 0;
	...
	private void jj_add_error_token(final int kind, final int pos) {
		...
		if (pos == jj_endpos + 1) {
			...
			for (final java.util.Enumeration e = jj_expentries.elements(); e
					.hasMoreElements();) {

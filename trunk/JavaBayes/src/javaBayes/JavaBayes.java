...
public class JavaBayes extends Applet {
	...
	public static void main(final String argv[]) {
		final JavaBayes jb = new JavaBayes();
		jb.construct(false);
		if (argv.length > 0) {
			final String filename = argv[0];
			// final String filename = "Examples\\Alarm\\ALARM.XML";
	 ...
	 */
	private void construct(final boolean ia) {
		is_applet = ia;
	 ...
	 */
	public void set_current_save_filename(final String filename) {

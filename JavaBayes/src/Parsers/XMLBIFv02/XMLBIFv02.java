...
public class XMLBIFv02 extends InterchangeFormat implements XMLBIFv02Constants {
	...
	final public IFProbabilityEntry ProbabilityEntry() throws ParseException {
		...
		final Vector v_list = new Vector();
		double d[];
	...
	public XMLBIFv02(final java.io.InputStream stream) {
	...
	public XMLBIFv02(final XMLBIFv02TokenManager tm) {
		token_source = tm;
		token = new Token();
		jj_ntk = -1;
		jj_gen = 0;
	...
	public void ReInit(final XMLBIFv02TokenManager tm) {
		token_source = tm;
		token = new Token();
		jj_ntk = -1;
		jj_gen = 0;
